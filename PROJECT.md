...
> blocks (old §1) were archived to `archive/PROJECT-start-here.md` on
> 2026-09-22; old → new paths are in `archive/MOVED.md`. New project-wide results still land here as §3.x sections.
...
Archived 2026-09-22 to `archive/PROJECT-start-here.md` (the "Resume here" blocks,
the machine, the tree, the traps). Start from `STATE.md`.
...
4. **Phase 2's runner needs a manifest** (`_write_run_manifest`) —
   `archive/docs/results_provenance_audit_2026-09-05.md` §3.1.
...
from `archive/docs/results_provenance_audit_2026-09-05.md` §3.1 (the Phase 2 OV
...
3. **The per-head co-location test — one stable CO-LOCATES, exploratory.** The
   ...
   **This is exploratory, not an adjudication.** Three anchors were tried and one
   ...
   registered before running (archive/POPPER_PLAN-done.md §C2's requirement). It is a
...
3. **"Matching kernel" stops being a metaphor.** The particle account's own
   ...
   feature-copying circuit" (`archive/POPPER_PLAN-done.md` §C2). The static QK half of this
...
`archive/docs/literature_scan_2026-09-10.md` could not claim and is now marked
superseded for.
...
Full record in **`archive/docs/literature_scan_2026-09-13.md`**; every id was fetched
...
`archive/docs/literature_scan_2026-09-10.md` covered §3.12-V only — the 7d/7e/8 territory. Every
...
`archive/docs/results_provenance_audit_2026-09-05.md` as moved aside on 2026-09-03).
...
* **`data/analysis/` is git-ignored, so every number quoted in a committed
  ...
  `archive/docs/results_provenance_audit_2026-09-05.md` §3.1 raises against Phase 2's
...
`archive/UPDATE_PLAN.md` §5.6's trace contraction). The other two were structural, and
...
| Are the on-disk phase12/phase7 results stale? | `archive/docs/results_provenance_audit_2026-09-05.md` |
