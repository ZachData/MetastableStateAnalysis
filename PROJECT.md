...
**The e-value audit, where it stands (§3.36, §3.40).** No prediction has an
...
| 7 | **NEXT, and last.** Four rows built and calibrated; `P-I1` scored but unrecorded; `P-I5` parked |
...
(`P-I1`, p = 0.1414, §3) has no committed record — it lives in git-ignored
