...
3. **Order.** Is any registered prediction scored on the 410m v2 runs before
   Phase 10 registers? (`CLAIM-C`, the example first given here, is not: its arms
   are 1.4b and gpt2-large, `docs/PHASE_SYNTHESIS.md` §3.3. None is today.)
