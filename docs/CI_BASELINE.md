...
Seven of them, as of the P6-R2/R4 dry run (2026-08-26).
...
All seven artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all seven
