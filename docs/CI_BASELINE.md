...
Twelve of them, as of the CLAIM-B grid feasibility record (2026-08-28).
...
All twelve artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all twelve
