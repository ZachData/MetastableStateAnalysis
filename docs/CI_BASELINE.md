...
was **1477 passed, 5 skipped, 251 deselected** on 2026-08-24 (1397 before the
CLAIM-B/P-I1 changepoint construction, 1351 before the Phase 6 revival, 1325
before the projector audit, 1298 at PR #12's merge).
...
Three of them, as of the CLAIM-B/P-I1 pass.
...
All three artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all three
