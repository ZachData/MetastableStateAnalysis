...
was **1504 passed, 5 skipped, 251 deselected** on 2026-08-25 (1477 before the
CLAIM-C dry run, 1397 before the CLAIM-B/P-I1 changepoint construction, 1351
before the Phase 6 revival, 1325 before the projector audit, 1298 at PR #12's
merge).
...
Four of them, as of the CLAIM-C dry run.
...
All four artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all four
