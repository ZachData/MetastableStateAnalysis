...
was **1397 passed, 5 skipped, 251 deselected** on 2026-08-24 (1351 before the
Phase 6 revival, 1325 before the projector audit, 1298 at PR #12's merge).
...
Both artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. Neither is in tier 0, and neither can be: both
