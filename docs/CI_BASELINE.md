...
was **1651 passed, 5 skipped, 251 deselected** on 2026-08-26 (1629 before the
...
Eight of them, as of the CLAIM-B/P-I1 dry run (2026-08-27).
...
All eight artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all eight
