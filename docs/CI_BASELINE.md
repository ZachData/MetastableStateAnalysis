...
was **1629 passed, 5 skipped, 251 deselected** on 2026-08-26 (1589 before
...
Six of them, as of P-ST1's dry run (2026-08-26).
...
All six artifacts are tracked only because `.gitignore`'s whitelist already
un-ignores `claims/**/*.json`. None is in tier 0, and none can be: all six
