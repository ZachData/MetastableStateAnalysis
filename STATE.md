...
**Last updated:** 2026-09-25 (Phase 1d float-noise drift, Stage 0 vs pilot) · **Cap:** 150 lines (tier-0 lint enforces it).
...
**PR for `claude/p1d-drift`** (drift measurement), in `../Mets-work`: open. #100 merged 2026-09-25, its branch and worktree removed. #99 merged 2026-09-25, its branch and worktree removed. #98 merged 2026-09-25, its branch and worktree removed. #97 merged 2026-09-25, its branch and worktree removed; #96, #95 merged 2026-09-25, branches and worktrees removed. #80–#94 merged 2026-09-24, branches and worktrees removed.
...
- Phase 10 free rows (tier 1): attention flip ~94 % causal mask; F0 fails; identity coupling optimal 99.5 %; HDBSCAN partition not reproducible (ARI p5 0.347, but that is almost all `repeated_tokens`; the other 7 prompts ≥ 0.925, `status-1d.md` "Float-noise drift") — `status-10.md`.
