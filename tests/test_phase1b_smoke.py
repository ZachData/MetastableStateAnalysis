...
def test_phase1b_per_run_json_and_md_written(tiny_phase1b_dir):
    """
    _save_run writes phase1b_{stem}.json and .md per (model, prompt) —
...
def test_phase1b_cross_run_digest_written(tiny_phase1b_dir):
    ...
    assert (tiny_phase1b_dir / "phase1b_cross_run.json").exists()
    assert (tiny_phase1b_dir / "phase1b_cross_run.md").exists()
