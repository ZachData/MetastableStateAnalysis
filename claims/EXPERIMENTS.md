...
| `9` | `p9_metric_intervention/` | parked, pre-design and deliberately unregistered. `plan-9.md` §13 states it: no construction frozen, no `P-*` id. Nothing has run under its name; its E0 ran as Phase 10's F1. |
