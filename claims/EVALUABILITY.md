...
| `P-S1` | H-RESIST | **e-value** | 1.0 | Already a matched random baseline: adjudication is on the RATIO Q_k / Q_k^random, whose 2-sigma band UPDATE_PLAN.md 5.8 measures (0.16-0.19 at k=1, 0.013-0.015 at k=2, 0.002 at k=3). That is a permutation null, so a one-sided permutation p-value follows directly, with resolution floor 1/(n_draws+1). |
