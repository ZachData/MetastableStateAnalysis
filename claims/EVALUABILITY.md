...
class, so `REGISTERED_EXCHANGEABLE_UNIT` is `None` and `adjudicate_p_ab1` raises
while it is. And a **fixed** offset between the real and control direction
